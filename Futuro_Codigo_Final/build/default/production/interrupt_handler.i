# 1 "interrupt_handler.asm"
# 1 "<built-in>" 1
# 1 "interrupt_handler.asm" 2
...
_adc_int_handler:
    ;BANKSEL ADRESH
    ;MOVFF ADRESH, _adc_result ;put the highest 8 bits of the conversion result in 0
    ...
    ;BANKSEL TX1REG
    ;MOVFF 0, TX1REG ;Q: put the 8 MSB of the ADC conversion in the UART TX.
