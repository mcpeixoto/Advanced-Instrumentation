...
# 1 "<built-in>" 1
# 1 "config.asm" 2
# 1 "/home/mcpeixoto/.mchp_packs/Microchip/PIC18F-Q_DFP/1.14.237/xc8/pic/include/xc.inc" 1 3




# 1 "/home/mcpeixoto/.mchp_packs/Microchip/PIC18F-Q_DFP/1.14.237/xc8/pic/include/pic18.inc" 1 3





# 1 "/home/mcpeixoto/.mchp_packs/Microchip/PIC18F-Q_DFP/1.14.237/xc8/pic/include/pic18_chip_select.inc" 1 3
# 195 "/home/mcpeixoto/.mchp_packs/Microchip/PIC18F-Q_DFP/1.14.237/xc8/pic/include/pic18_chip_select.inc" 3
# 1 "/home/mcpeixoto/.mchp_packs/Microchip/PIC18F-Q_DFP/1.14.237/xc8/pic/include/proc/pic18f47q10.inc" 1 3
# 47 "/home/mcpeixoto/.mchp_packs/Microchip/PIC18F-Q_DFP/1.14.237/xc8/pic/include/proc/pic18f47q10.inc" 3
CLCIN0PPS equ 0E1Fh
...
TOSU equ 0FFFh
# 26985 "/home/mcpeixoto/.mchp_packs/Microchip/PIC18F-Q_DFP/1.14.237/xc8/pic/include/proc/pic18f47q10.inc" 3
...
# 196 "/home/mcpeixoto/.mchp_packs/Microchip/PIC18F-Q_DFP/1.14.237/xc8/pic/include/pic18_chip_select.inc" 2 3
# 7 "/home/mcpeixoto/.mchp_packs/Microchip/PIC18F-Q_DFP/1.14.237/xc8/pic/include/pic18.inc" 2 3
...
CONFIG FEXTOSC=0b100 ;deactivate external oscillator (to allow write to ((PORTA) and 0FFh), 7, a)
...
_config:
    ...
    MOVLW 0b00000001
    BANKSEL TRISA
    MOVWF TRISA,1 ;defines the pin direction. 0=out, 1=in. ((PORTA) and 0FFh), 0, a connects to potenciometer. All other are output pins

    MOVLW 0b00000001
    BANKSEL ANSELA
    MOVWF ANSELA,1 ;analog select. ((PORTA) and 0FFh), 0, a connects to potenciometer. The others are digital pins
    ...
    MOVLW 0b00000111
    BANKSEL LATB
    MOVWF LATB,1 ;defines the pin direction. 0=out, 1=in. ((PORTA) and 0FFh), 0, a connects to potenciometer. All other are output pins

    MOVLW 0b00000111
    BANKSEL ANSELB
    MOVWF ANSELB,1 ; analog select. ((PORTB) and 0FFh), 0, a, ((PORTB) and 0FFh), 1, a, ((PORTB) and 0FFh), 2, a connects to accelerometer. The others are digital pins
    ...
    BSF TRISC,7 ;except ((PORTC) and 0FFh), 7, a, that will be used as RX - microchip specifies RX as input pin
    ...
    BANKSEL RC4PPS
    MOVLW 0b00001001 ; Q: WHAT VALUE MUST WE GIVE ((STATUS) and 0FFh), 6, a RC4PPS ((STATUS) and 0FFh), 6, a PUT THE EUSART1 TX ((CWG1CON1) and 0FFh), 5, b PIN ((PORTC) and 0FFh), 4, a? HINT: look in the 17.2 section of the datasheet, table 17.2
    MOVWF RC4PPS ;place the EUSART1 (TX/CK) in ((PORTC) and 0FFh), 4, a

    BANKSEL RX1PPS
    MOVLW 0b00010111 ; Q: WHAT VALUE MUST WE GIVE ((STATUS) and 0FFh), 6, a RX1PPS ((STATUS) and 0FFh), 6, a PUT THE EUSART1 RX ((CWG1CON1) and 0FFh), 5, b PIN ((PORTC) and 0FFh), 7, a? HINT: look in the PPS chapter of the datasheet

    MOVWF RX1PPS ;place the EUSART1 (RX) in ((PORTC) and 0FFh), 7, a
    ...
    ; Q: WHAT VALUE SHOULD WE PUT ((CWG1CON1) and 0FFh), 5, b SP1BRGL AND SP1BRG1H ((STATUS) and 0FFh), 6, a GET A BAUD RATE OF 9600 BPS FOR A CLOCK SPEED OF 32 MHZ? HINT: CHECK SECTION 28.2
    ...
    ; ADPCH Possibilities
    ; 001011 ((PORTB) and 0FFh), 3, a/ANB3
    ; 001010 ((PORTB) and 0FFh), 2, a/ ANB2
    ; 001001 ((PORTB) and 0FFh), 1, a/ ANB1
    ; 001000 ((PORTB) and 0FFh), 0, a/ANB0
    ; 000000 ((PORTA) and 0FFh), 0, a/ANA0
    ...
    BANKSEL ADCLK
    MOVLW 0b00001111 ; Q: SET THE ADC CLOCK FREQUENCY ((STATUS) and 0FFh), 6, a 1 MHZ, KNOWING THAT FOSC = 32 MHZ
    MOVWF ADCLK,1


    BANKSEL ADCON0
    MOVLW 0b00000000 ;Q: SET THE ADC ((STATUS) and 0FFh), 6, a: results left-justified, clock=Fosc/div, non-continuous operation
    MOVWF ADCON0,1
